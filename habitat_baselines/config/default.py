...
_C.LOAD_LAST_CHECKPOINT = False # resume the training procedure
_C.TRAIN_W_REAL_IMAGES = False
_C.REAL_IMAGES_PATH = ""
...
_C.EVAL_LOAD_LAST_CHECKPOINT = True
_C.EVAL_W_REAL_IMAGES = False
# -----------------------------------------------------------------------------
